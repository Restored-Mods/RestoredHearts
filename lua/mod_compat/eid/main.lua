...
local function ActOfContritionConditions(descObj)
	return descObj.ObjType == 5
		...
		and descObj.ObjSubType == CollectibleType.COLLECTIBLE_ACT_OF_CONTRITION
...
EID:addDescriptionModifier(
	"Immortal Act of Contrition Modifier",
	ActOfContritionConditions,
	ActOfContritionModifierCallback
)

RestoredHearts:AddModCompat("RestoredCollection", function()
	local function AncientRevelationConditions(descObj)
		return descObj.ObjType == 5
			and descObj.ObjVariant == 100
			and descObj.ObjSubType == RestoredCollection.Enums.CollectibleType.COLLECTIBLE_ANCIENT_REVELATION
	end
	...
	EID:addDescriptionModifier(
		"Immortal Ancient Revelation Modifier",
		AncientRevelationConditions,
		AncientRevelationModifierCallback
	)
end)
