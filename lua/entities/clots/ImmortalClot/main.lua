...
function ImmortalClotLocal:ClotHeal()
	...
	if playsfx then
		sfx:Play(RestoredHearts.Enums.SFX.Hearts.IMMORTAL_PICKUP, 1, 0, false, 1.4)
	end
...
RestoredHearts:AddCallback(ModCallbacks.MC_PRE_SPAWN_CLEAN_AWARD, ImmortalClotLocal.ClotHeal)
